...
export const InfoComponent = ({ order }: Props) => {
  return (
    ...
    >
      ...
      {order.shipping && (
        <div className="w-full h-full flex flex-col pl-10 gap-1">
          <h5 className="lg:text-base text-xs pl-4 lg:pl-5 mt-3">
            {order.shipping.name || "No information provided"}
          </h5>
          <h5 className="lg:text-base text-xs pl-4 lg:pl-5">
          ...
          <p className="lg:text-sm text-xs text-black pt-5 items-center text-wrap w-full">
